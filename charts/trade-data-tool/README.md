...
![Version: 0.5.2](https://img.shields.io/badge/Version-0.5.2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2.4.0](https://img.shields.io/badge/AppVersion-2.4.0-informational?style=flat-square)
...
| zeppelin.persistence.enabled | bool | `true` |  |
| zeppelin.persistence.retainOnDelete | bool | `false` |  |
| zeppelin.persistence.size | string | `"10Gi"` |  |
