...
| service.image.custom.version | string | `"142496269814.dkr.ecr.us-west-2.amazonaws.com/onyxia-vscode-pytorch:py3.11.14"` |  |
| service.image.pullPolicy | string | `"IfNotPresent"` |  |
| service.image.version | string | `"142496269814.dkr.ecr.us-west-2.amazonaws.com/onyxia-vscode-pytorch:py3.11.14"` |  |
