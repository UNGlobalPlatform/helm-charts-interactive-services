...
![Version: 0.1.10](https://img.shields.io/badge/Version-0.1.10-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.1.0](https://img.shields.io/badge/AppVersion-1.1.0-informational?style=flat-square)
...
| web.port | int | `7108` |  |
| zeppelin.apiUrl | string | `""` |  |
| zeppelin.defaultInterpreterGroup | string | `"jdbc"` |  |
| zeppelin.driverArtifact | string | `"org.mariadb.jdbc:mariadb-java-client:3.4.1"` |  |
| zeppelin.password | string | `""` |  |
| zeppelin.username | string | `"onyxia"` |  |
| zeppelin.webUrl | string | `""` |  |
